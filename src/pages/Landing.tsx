...
const Landing = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "From Paris to Patagonia, WanderPlan crafts plans for any location with hidden gems included.",
    },
  ];
  const testimonials = [
    {
      name: "Sneha Patil",
      quote:
        "WanderPlan simplified my Konkan family trip planning! The itinerary included perfect homestays and local seafood spots we’d have missed otherwise.",
    ...
    },
    {
      ...
      quote:
        "The quick summary feature is a lifesaver! For our Mahabaleshwar trip, WanderPlan gave us a plan in minutes, saving me so much effort.",
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100/50 to-purple-100/50">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Discover Your Perfect Adventure with WanderPlan
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Link to="/plan">
              <Button
                ...
                aria-label="Get started with WanderPlan"
              >
                Get Started Now
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                preferences. WanderPlan’s AI generates a detailed itinerary in
              ...
              <div className="space-y-4">
                ...
                <div className="prose prose-sm text-gray-700">
                  ...
                  <p className="text-blue-600 italic">
                    Generated by WanderPlan’s AI in seconds!
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Join thousands of travelers who trust WanderPlan to create unforgettable
          ...
          >
            <Link to="/plan">
              <Button
                ...
                aria-label="Plan your trip with WanderPlan"
              >
                Plan Your Trip Now
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
