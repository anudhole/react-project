  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="max-w-7xl mx-auto py-16 px-6">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900 mb-4">About Travzi</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
            Travzi is an AI-powered travel companion designed to make trip planning simple, personalized, and delightful. Founded in 2023 in India, we combine cutting-edge technology with a passion for exploration to craft tailored itineraries for any destination—whether it’s a bustling city or a tranquil retreat.
          </p>
          <Link to="/plan">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                At Travzi, we aim to empower travelers with seamless, AI-driven planning tools that save time and uncover hidden gems. Whether you’re a solo adventurer, a family on vacation, or a professional on a business trip, we’re here to make every journey unforgettable.
              </p>
            </div>
        ...
        >
          <h3 className="text-2xl font-semibold text-gray-900 text-center mb-8">Why Choose Travzi?</h3>
